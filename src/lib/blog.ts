...
<div style="border:1px solid #E6E5E2;border-radius:12px;overflow:hidden;margin:1.5rem 0;">
  ...
  <div style="padding:0.85rem 1rem;border-bottom:1px solid #F0EFED;">
    <div style="color:#66686D;text-transform:uppercase;letter-spacing:0.3px;font-size:0.95rem;margin-bottom:0.25rem;">Ortopedista Geral</div>
    <div style="color:#1A2E3B;font-weight:500;">Trata o sistema locomotor como um todo.</div>
  </div>
  <div style="padding:0.85rem 1rem;">
    <div style="color:#66686D;text-transform:uppercase;letter-spacing:0.3px;font-size:0.95rem;margin-bottom:0.25rem;">Especialista em Mão</div>
